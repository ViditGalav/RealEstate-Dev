...
export default function Home() {
  ...
  return (
    <div className='flex flex-col transition-height duration-75 ease-out bg-gradient-to-tr from-slate-900 to-red-950 min-h-screen min-w-full'>
      ...
      <div className='sticky top-0 left-0 h-[90vh] flex max-md:hidden bg-gradient-to-tr from-slate-900 to-red-950'>
        {(role === "owner" || role === "tenant") && (
          <div>
            <Dashboard closeToggle={setToggleDashboard} user={user && user} role={role} />
          </div>
        )}
